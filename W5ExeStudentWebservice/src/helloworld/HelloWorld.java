...
/**
 * This class is the web service resource class
 * It has all the get , post methods.
 * **/
...
public class HelloWorld {
    ...
    public void setPostName( @FormParam("name") String content) {
    	System.out.println("Tony Thomas: In post method ***********************************************");
    nameStorage.setName(content);
    	System.out.println("Tony Done with post *************************************************");
